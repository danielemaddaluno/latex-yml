...
%
%\ifthenelse{\boolean{highschool}}{}{
%\include{3_data_prep/3_data_prep}
%}
%
%\include{4_unsupervised/4_unsupervised}
%\include{5_supervised/5_supervised}
%%\include{99_old_misuraca_trash}
%\input{6_summary/6_summary}
